...
Para auxiliar no monitoramento operacional, o projeto foi estruturado para entregar:
...
- **Matriz de Consumo:** Registro contínuo do consumo diário dos recursos vitais em uma estrutura bidimensional.
- **Análise Estatística:** Processamento de médias, identificação de picos de consumo e emissão automática de alertas de esgotamento.
...
- **Processamento Estatístico de Picos:** Algoritmos de varredura que percorrem a matriz para extrair os maiores valores registrados por coluna e mapear em qual dia ocorreram os picos operacionais.
...
.
├── src/                  
│   └── Projeto_final_missao_orion.c            # Código-fonte principal do sistema
